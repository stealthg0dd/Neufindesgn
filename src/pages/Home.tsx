          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl lg:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed testimonial-text">
                Your AI-powered Neural Twin analyzes millions of market decisions to eliminate emotional trading 
                and quantify exactly how much more you could be earning.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                ...
                >
                  <Button 
                    asChild
                    size="lg" 
                    className="px-8 py-4 text-lg bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 touch-target"
                    role="button"
                    aria-label="Start your 14-day free trial with Neural Twin AI"
                  >
                ...
                <Button 
                  ...
                  variant="outline" 
                  size="lg" 
                  className="px-8 py-4 text-lg group touch-target border-purple-500/30 hover:bg-purple-500/10"
                  role="button"
                  aria-label="Watch Neural Twin demo video"
                >
              ...
              <div className="flex items-center justify-center space-x-6 text-sm mt-6">
                ...
                >
                  <span>View Dashboard (Mock)</span>
                  <ArrowRight className="h-4 w-4" />
                </Link>
                <span className="text-muted-foreground">•</span>
                <Link 
                  to="/user-journey-mock" 
                  className="text-blue-400 hover:text-blue-300 transition-colors flex items-center space-x-1"
                >
                  <span>View User Journey (Mock)</span>
                  <ArrowRight className="h-4 w-4" />
                </Link>
              </div>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8 testimonial-text">
              Join thousands of traders who've improved their Alpha Score with Neural Twin AI.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <Button 
                  asChild
                  size="lg" 
                  className="cta-button px-8 py-4 text-lg touch-target"
                  role="button"
              ...
              <Button 
                ...
                variant="outline" 
                size="lg" 
                className="px-8 py-4 text-lg border-purple-500/30 hover:bg-purple-500/10 touch-target"
                role="button"
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl testimonial-text">
              Neufin AI operates across multiple markets, bringing institutional-grade trading intelligence worldwide.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            >
              <Card className="h-full bg-card/50">
                <CardHeader>
                  <CardTitle className="flex items-center gap-3 text-xl" style={{ color: 'var(--heading-secondary)' }}>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {[
                      { country: 'Singapore', flag: '🇸🇬', role: 'Asia-Pacific HQ' },
                      { country: 'Estonia', flag: '🇪🇪', role: 'European Operations' },
                      { country: 'Thailand', flag: '🇹🇭', role: 'Southeast Asia Hub' },
                      { country: 'Vietnam', flag: '🇻🇳', role: 'Emerging Markets' },
                      { country: 'UAE', flag: '🇦🇪', role: 'Middle East & Africa' }
                    ].map((location, index) => (
                      <motion.div
                        ...
                        viewport={{ once: true }}
                        className="flex items-center gap-3 p-3 border border-border rounded-lg hover:border-purple-500/30 transition-colors"
                      >
                        <span className="text-2xl">{location.flag}</span>
                        <div>
                          <div className="font-medium">{location.country}</div>
                          <div className="text-sm text-muted-foreground">{location.role}</div>
                        </div>
                      </motion.div>
                    ))}
                  </div>
                  
                  <div className="flex items-center gap-3 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg mt-6">
                    <Globe className="h-5 w-5 text-blue-400" />
                    <div>
                      <div className="font-medium text-blue-400">Expanding Soon</div>
                      <div className="text-sm text-muted-foreground">Opening to new locations based on market demand</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4 p-4 border border-border rounded-lg">
                      ...
                      <div className="flex-1">
                        <div className="font-medium mb-1">Business Inquiries</div>
                        <a 
                        ...
                        <div className="text-sm text-muted-foreground mt-1">
                          General questions, partnerships, and enterprise solutions
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 border border-border rounded-lg">
                      ...
                      <div className="flex-1">
                        <div className="font-medium mb-1">Free Trial & Demo</div>
                        <Link 
                          to="/login" 
                          state={{ from: 'free-trial' }}
                    ...
                    <div className="flex items-start gap-4 p-4 border border-border rounded-lg">
                      ...
                      <div className="flex-1">
                        <div className="font-medium mb-1">Institutional Clients</div>
                        <a 
                          href="mailto:info@neufin.ai?subject=Enterprise Solutions Inquiry&body=Hi, I'm interested in learning more about Neufin's enterprise solutions for institutional clients." 
                          className="text-blue-400 hover:text-blue-300 transition-colors"
                        >
                          Enterprise Solutions
                        </a>
                        <div className="text-sm text-muted-foreground mt-1">
                          Custom implementations and white-label solutions
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          >
            <div className="flex items-center justify-center gap-2 mb-4">
              <img
                ...
                className="w-8 h-8"
              />
              <span className="text-xl font-bold" style={{ color: 'var(--heading-secondary)' }}>
                Neufin AI
              </span>
            </div>
            <p className="text-muted-foreground mb-4">
              Democratizing access to institutional-grade trading intelligence through Neural Twin AI
            </p>
            <div className="text-sm text-muted-foreground">
              © 2025 Neufin AI. All rights reserved.
            </div>
          </motion.div>
        </div>
      </footer>
